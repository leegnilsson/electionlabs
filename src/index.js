...
import geoJsonData from "./data-storage/us_states_shapes.json"; //loads states shapefiles
import electionData from "./data-storage/presElectionResults.json"; //loads election 76 data
